...
QUESTION = (
    "A supplier breached a contract by failing to deliver custom software on time, "
    "causing the buyer to lose a major customer. What remedies and case law apply?"
)
...
SYSTEM_PROMPT = (
    ...
    "the legal database and case law separately. Keep your final answer under 500 words."
)
